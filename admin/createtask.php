...
<form id="taskForm" class="task-form">
  <div class="form-group">
    ...
    <select id="employeeName" class="form-select">
      ...
      <option>Fajar Rafiudin</option>
      <option>Odi Rinanda</option>
      <option>Yosef Tobir</option>
      <option>M. Nuril Adinata</option>
      <option>Aji Pangestu</option>
      <option>Erik Efendi</option>
      <option>Eddo Bentano</option>
      <option>Herlando</option>
      <option>Imam Sutrisno</option>
      <option>PKL</option>
    </select>
  </div>
  ...
  <select id="taskTypes" class="form-select" multiple required>
    ...
    <option value="E2E">E2E</option>
      ...
      <div class="form-group">
        ...
        <input type="text" id="target" class="form-input" placeholder="e.g., 50 WO/HARI">
      </div>
